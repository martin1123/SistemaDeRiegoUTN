...
void InitUART0(void)
{
    ...
    U0LCR0 = 0x00000083;    //3.- Registro U1LCR - Tx de 8 bits, 1 bit de stop, sin paridad, sin break cond, DLAB = 1
...
//5.- Registros PINSEL0 (0x4002C000) y PINSEL1 (0x4002C004) - habilitan las funciones especiales de los pines:
    ...
    U0LCR0 = 0x03;		 //6.- Registro U1LCR, pongo DLAB en 0

    U0IER = IER_RBR | IER_THRE ;		// Habilito interrupciones
    ISER0 |= (1<<6);
}
